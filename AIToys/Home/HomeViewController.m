...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    headView.semanticContentAttribute = isRTL ? UISemanticContentAttributeForceRightToLeft : UISemanticContentAttributeForceLeftToRight;
    UILabel *titleLab = [UILabel new];
    titleLab.textColor = UIColorHex(131516);
    titleLab.font = [ATFontManager boldSystemFontOfSize:20];
    titleLab.semanticContentAttribute = headView.semanticContentAttribute;
    titleLab.textAlignment = isRTL ? NSTextAlignmentRight : NSTextAlignmentLeft;
    ...
    if(section ==0 || section ==1){
        ...
        moreBtn.titleLabel.textAlignment = isRTL ? NSTextAlignmentLeft : NSTextAlignmentRight;
        moreBtn.contentHorizontalAlignment = isRTL ? UIControlContentHorizontalAlignmentLeft : UIControlContentHorizontalAlignmentRight;
